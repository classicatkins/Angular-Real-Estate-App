...
export declare class NgxPopperjsLooseDirective extends NgxPopperjsDirective {
    ...
    constructor(changeDetectorRef: ChangeDetectorRef, elementRef: ElementRef, vcr: ViewContainerRef, popperDefaults?: NgxPopperjsOptions);
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxPopperjsLooseDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxPopperjsLooseDirective, "[popperLoose]", ["popperLoose"], { "popperLoose": { "alias": "popperLoose"; "required": false; }; "popperLoosePlacement": { "alias": "popperLoosePlacement"; "required": false; }; "popperLooseTrigger": { "alias": "popperLooseTrigger"; "required": false; }; }, {}, never, never, true, never>;
}
